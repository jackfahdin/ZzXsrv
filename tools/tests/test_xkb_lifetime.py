...
class XkbLifetimeTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        includes = [".", "include", "third_party/pthreads",
                    ...
                    "src/xorg-server/mi", "src/xorg-server/render", "src/xorg-server/Xext", "src/xorg-server/Xi",
        ...
        command = [compiler, "/nologo", "/std:c11", "/Od", "/Gy", "/Gw", "/Zc:inline", "/MD", "/Zi",
                   ...
                   *["/D" + d for d in defines],
                   str(ROOT / "tools/tests/native/xkb_lifetime.c"),
    ...
    def test_controls(self):
        self.run_case("controls")

    def test_absent(self):
        self.run_case("absent")

    def test_no_key(self):
        self.run_case("no-key")
