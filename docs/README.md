...
初次使用请先阅读[项目首页](../README.md)和 [Windows 原生构建指南](build/WINDOWS.md)。源码职责与旧路径对应关系见[源码目录分层设计](designs/2026-09-10-source-layout.md)和[路径映射](history/2026-09-10-source-path-mapping.json)。当前维护状态以[计划与功能状态](maintenance/PLAN_STATUS.md)为准，历史报告中的提交、分支、路径和测试数字保留当时语境。

本次[源码分层验证](validation/2026-09-10-source-layout.md)记录目录迁移后的完整构建、61 项测试和实际运行结果。
...
| [脚本与文档目录迁移验证](validation/2026-09-10-readme-layout.md) | 前次中文首页、脚本和文档目录整理的构建、测试与文件核对 |
...
| [源码目录说明](../src/) / [第三方组件说明](../third_party/) / [公共头文件说明](../include/) | 当前源码分层、目录职责和来源边界 |
...
- [源码路径映射](history/2026-09-10-source-path-mapping.json)：2026-09-10 分层前后的精确顶层目录对应关系。
