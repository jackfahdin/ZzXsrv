...
[R6 Expat 升级](2026-09-15-expat.md)候选已在独立目录构建：官方 Expat 2.8.4、Windows 随机源与静态配置，保留 Mesa 的静态配置行为。完整构建经 MSVC 异常恢复后完成，404 项测试通过、0 跳过，独立运行检查 PASS；构建源码 `73e74d4bd`。本版本待人工反馈，未合入、未推送。
