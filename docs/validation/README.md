...
[R9.3 Pixman](2026-09-16-r9-pixman.md)：R9.3 Pixman 0.46.4 候选已完成。完整 x64 Release 构建、442 项回归（0 跳过）、独立运行及实际 Render 像素检查通过。编译源码 `d9117d088946b0e7a5fa45f19f952c7522d099d3`，后续仅修正来源元数据与文档。尚未取得本版本人工反馈，未合入或推送；R9.2 仍为最新已验收版本，新旧目录保留。
