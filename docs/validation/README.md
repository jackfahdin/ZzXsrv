...
[R9.4 Fontconfig 2.18.3](2026-09-16-r9-fontconfig.md)：R9.4 Fontconfig 2.18.3 候选已完成。完整 x64 Release 构建、449 项回归（0 跳过）、7 项 Fontconfig 消费者检查、独立运行及新旧缓存共存检查通过。编译源码 `6b2f8aecfefd52bd18dee3e95e754309cab6d38e`，后续仅修正继承签出记录与文档。尚未取得本版本人工反馈，未合入或推送；R9.3 仍为最新已验收版本，新旧目录保留。
