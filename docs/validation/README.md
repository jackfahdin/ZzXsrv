...
[R9.1 libX11 1.8.13](2026-09-15-r9-libx11.md)已完成 libX11 1.8.13 候选：完整 x64 Release 构建通过，425 项实际产物回归通过、0 跳过，独立运行检查 PASS。构建源码 `f1e9330b0d62078e4a3ed5bdb0b0fecce9f2830d`。尚未取得本版本人工反馈，未合入 master、未推送；R8 及更早目录保留。
