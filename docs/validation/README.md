...
[R8 键盘、图标与压缩依赖候选](2026-09-15-r8-dependencies.md)已就绪：xkbcomp 1.5.0、libXpm 3.5.19、zlib 1.3.2；完整构建、提交前后各 420 项回归（0 跳过）及独立运行检查通过，5143 个运行文件。源码 `4f8ddf84a`，等待本版本人工验收，未合入、未推送。
