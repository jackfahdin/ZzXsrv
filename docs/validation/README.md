...
[R7 OpenSSL 3.5.8 LTS](2026-09-15-openssl.md)已完成独立候选：官方 5767 文件原样导入，完整 x64 Release All 构建成功，410 项测试通过、0 跳过，独立运行检查 PASS；旧 R6 对象与 R7 交付 DLL 的 6 项兼容对照通过。构建源码 `e41de0979`，新目录 5136 个文件，R6 原目录保持不变；待本版本实际反馈，未合入或推送。
