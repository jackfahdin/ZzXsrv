...
[R9.2 libxcb](2026-09-16-r9-xcb.md)：R9.2 候选已完成，libxcb/xcb-proto 保持 1.17.0。完整 x64 Release 构建、433 项实际回归（0 跳过）及独立运行检查通过。构建源码 `17f39e75cfc44c42b8b1af8225841a643d1c510f`。尚未取得本版本人工反馈，未合入或推送；已验收的 R9.1 及更早目录保留。
