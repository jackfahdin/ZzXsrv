...
> 2026-09-14 最新整合：GLX 属性、字体消费方和 RANDR 已分别提交、取得本版本实际使用确认并快进合入 master，合入前后各 350 项测试通过，见[整合报告](2026-09-14-r3-final.md)。R3 历史清单 21/21 项均已整合。下文的 18 项进度、“待实施”和逐项源码状态保留为先前检查基线，不代表当前缺口。

> 2026-09-14 更新：下表保留原盘点时的源码状态；其中 CVE-2025-49176、CVE-2025-49178 已按当前目录恢复、重新验证并合入主线，见[输入整合报告](2026-09-10-xserver-input-integration.md)。RENDER/RECORD 两项也已取得本组使用确认并快进合入 master，见[本组报告](2026-09-10-render-record.md)；XKB 8 项也已取得本组使用确认并快进合入 master，见 [XKB 整合报告](2026-09-10-xkb.md)。XSYNC/PRESENT/屏保 6 项及认证补充也已取得各自使用确认并快进合入 master，见[整合报告](2026-09-11-auth-binary.md)。历史 21 项中共 18 项已整合，剩余 GLX 属性、字体消费方和 RANDR 3 项待实施；认证补充不增加历史计数。旧文中的 upstream 分支合并方案已由当前单主线来源文档规则替代。
