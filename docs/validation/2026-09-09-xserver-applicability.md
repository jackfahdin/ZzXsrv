...
> 2026-09-14 候选更新：剩余 GLX 属性、字体消费方和 RANDR 已在 `codex/r3-final-20260914` 分别提交，见[候选验证报告](2026-09-14-r3-final.md)。主线仍为 18/21 项已整合；下文的“待实施”和逐项源码状态保留为此前检查基线，不代表候选尚未开发。
