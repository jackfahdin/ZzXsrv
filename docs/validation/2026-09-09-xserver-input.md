...
初始记录日期：2026-09-09；实际使用反馈更新：2026-09-10。当前状态：**输入修复已恢复至当前源码布局并完成主线整合；本次完整构建及 73 项测试见[整合报告](2026-09-10-xserver-input-integration.md)，菜单跨屏异常按维护者要求暂缓排查**。
...
人工反馈补录后，修复已恢复到当前布局并重新构建验证、整合。下面的构建、71 项测试和“待实际使用”描述均为 2026-09-09 的历史检查点；2026-09-10 的构建及 73 项测试结果以[整合报告](2026-09-10-xserver-input-integration.md)为准。
