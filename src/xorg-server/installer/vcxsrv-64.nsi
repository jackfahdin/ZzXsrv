...
Section "VcXsrv (required)"
  ...
  File "..\system.XWinrc"
  File "..\X0.hosts"
  File "..\..\..\third_party\xorg\xkbcomp\obj64\release\xkbcomp.exe"
  File "..\..\..\third_party\xorg\apps\xhost\obj64\release\xhost.exe"
  File "..\..\..\third_party\xorg\apps\xrdb\obj64\release\xrdb.exe"
  File "..\..\..\third_party\xorg\apps\xauth\obj64\release\xauth.exe"
  File "..\..\..\third_party\xorg\apps\xcalc\obj64\release\xcalc.exe"
  File "..\..\..\third_party\xorg\apps\xcalc\app-defaults\xcalc"
  File "..\..\..\third_party\xorg\apps\xcalc\app-defaults\xcalc-color"
  File "..\..\..\third_party\xorg\apps\xclock\obj64\release\xclock.exe"
  File "..\..\..\third_party\xorg\apps\xclock\app-defaults\xclock"
  File "..\..\..\third_party\xorg\apps\xclock\app-defaults\xclock-color"
  File "..\..\..\third_party\xorg\apps\xwininfo\obj64\release\xwininfo.exe"
  File "..\XKeysymDB"
  File "..\..\..\third_party\xorg\libX11\src\XErrorDB"
  File "..\..\..\third_party\xorg\libX11\src\xcms\Xcms.txt"
  File "..\XtErrorDB"
  File "..\font-dirs"
  File "..\.Xdefaults"
  File "..\hw\xwin\xlaunch\obj64\release\xlaunch.exe"
  File "..\..\..\tools\plink\obj64\release\plink.exe"
  File "..\..\..\third_party\graphics\mesalib\src\obj64\release\swrast_dri.dll"
  File "..\hw\xwin\swrastwgl_dri\obj64\release\swrastwgl_dri.dll"
  File "..\..\..\third_party\graphics\dxtn\obj64\release\dxtn.dll"
  File "..\..\..\third_party\libxml2\build\x64\Release\libxml2.dll"
  File "..\..\..\third_party\libiconv\build\x64\Release\libiconv.dll"
  File "..\..\..\third_party\zlib\obj64\release\zlib1.dll"
  File "..\..\..\third_party\xorg\libxcb\src\obj64\release\libxcb.dll"
  File "..\..\..\third_party\xorg\libXau\obj64\release\libXau.dll"
  File "..\..\..\third_party\xorg\libX11\obj64\release\libX11.dll"
  File "..\..\..\third_party\xorg\libXext\src\obj64\release\libXext.dll"
  File "..\..\..\third_party\xorg\libXmu\src\obj64\release\libXmu.dll"
  File "..\..\..\third_party\openssl\release64\libcrypto-3-x64.dll"
  File "..\..\..\third_party\fonts\freetype\objs\x64\Release\freetype.dll"
  ...
  File "..\..\..\third_party\xorg\libXpm\README.vcxsrv.md"
  SetOutPath $INSTDIR\licenses\zlib
  File "..\..\..\third_party\zlib\LICENSE"
  File "..\..\..\third_party\zlib\README.vcxsrv.md"
  SetOutPath $INSTDIR\licenses\openssl
  File "..\..\..\third_party\openssl\LICENSE.txt"
  File "..\..\..\third_party\openssl\README.vcxsrv.md"
  SetOutPath $INSTDIR\licenses\expat
  File "..\..\..\third_party\expat\COPYING"
  File "..\..\..\third_party\expat\README.vcxsrv.md"
  SetOutPath $INSTDIR\licenses\libxml2
  File "..\..\..\third_party\libxml2\source\Copyright"
  File "..\..\..\third_party\libxml2\README.vcxsrv.md"
  SetOutPath $INSTDIR\licenses\libiconv
  File "..\..\..\third_party\libiconv\source\COPYING.LIB"
  File "..\..\..\third_party\libiconv\source\COPYING"
  File "..\..\..\third_party\libiconv\README.vcxsrv.md"
  SetOutPath $INSTDIR
...
Section "Uninstall"
  ...
  RMDir /r "$INSTDIR\licenses\expat"
  RMDir /r "$INSTDIR\licenses\libxml2"
  RMDir /r "$INSTDIR\licenses\libiconv"
