...
Section "VcXsrv (required)"
  ...
  File "..\..\..\third_party\libxml2\bin\libxml2-2.dll"
  File "..\..\..\third_party\libxml2\bin\libgcc_s_sjlj-1.dll"
  File "..\..\..\third_party\libxml2\bin\libiconv-2.dll"
  File "..\..\..\third_party\libxml2\bin\libwinpthread-1.dll"
